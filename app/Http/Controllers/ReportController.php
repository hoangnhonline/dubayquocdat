...
class ReportController extends Controller
{
    ...
    public function customerByLevel(Request $request){
        ...
        return view('report.customer-by-level', compact('month', 'year', 'listUser', 'arrUser', 'time_type', 'arrSearch', 'arrResult', 'arrLevel', 'level', 'id_loaitru'));
    ...
    public function doanhthuthang(Request $request){       
        ...
        return view('report.doanh-thu-thang', compact('arrDay', 'tong_thuc_thu', 'tong_hoa_hong_sales', 'arrCost', 'tong_chi','maxDay', 'minDateFormat', 'maxDateFormat', 'month', 'year', 'cateList', 'type', 'tong_chi_phi_van_hanh', 'tong_chi_phi_khac'));
